...
figure
hold on
for i = 1:33; plot([0 0],'LineWidth', 8,'Color',labelColors(i,:));end;
...
figure
hold on
for i = 1:length(qrSet.candidateLInd); plot([0 0],'LineWidth', 8,'Color',labelColors(qrSet.candidateLInd(i),:));end;
legend([gtL.names(qrSet.candidateLInd)]);
%legend(gtL.names);
